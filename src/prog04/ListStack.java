...
public class ListStack<E> implements StackInterface<E> {
    ...
    public E peek(){
        ...
        // if not empty return the top value within the list range
    ...
    public E pop(){
        ...
        // if not empty remove the last index within the list range
    ...
    public boolean empty(){
        // if size == 0 that means there's no data inside
