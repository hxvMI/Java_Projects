...
//    }
//
//    //    private static UserInterface ui = new GUI("Fibonacci experiments");     //Replace this with TestUI
//    private static UserInterface ui = new TestUI("Fibonacci experiments");     //Replace this with TestUI
//
//    /**
...
//            if (Integer.parseInt(s) < 0) { // number is negative return -1
//                ui.sendMessage(s + " is negative. Input is invalid.");
//                return -1;
//            }
//        }
//        catch (NumberFormatException e){ // is not number return -1
...
//            n = getInteger();
//            if (n == -1)return;         // if n is -1 CANCEL
//
//
//
