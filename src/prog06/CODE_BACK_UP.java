...
//
//
//            // sorted letters are the key, the value being
//            // added to the key is the actual word
//            map.put(sort(word),word);
//
//
//            ///
//
//            //  8: Remove the word using its key.
...
//            String word = null;
//
//            //  1:  Look up the jumble in the map.
//            // What key do you use?
...
//
//
//            //we use the sorted version of words to look up values
