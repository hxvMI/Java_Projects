...
/////////////////////////////////////////////////////////////////
		...
		//if line0 is null print line1
		if (line0 == null){
			out.println(line1);
			line1 = nextLine(in1, n, n1++);
		}
		//if line1 is null print line0
		else if (line1 == null){
			out.println(line0);
			line0 = nextLine(in0, n, n0++);
		}
		//if line1 is bigger than line0
		//it means line0 comes first (smaller number comes first when counting)
		// == is there because if they are equal either can go first
		else if (line1.compareTo(line0) >= 0){
			out.println(line0);
			line0 = nextLine(in0, n, n0++);
		}
		//if line0 is bigger than line1
		//it means line1 comes first (smaller number comes first when counting)
